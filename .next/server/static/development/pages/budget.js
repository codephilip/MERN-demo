...
function Budget() {
  ...
  async function handleImageUpload() {
    ...
    const response = await axios__WEBPACK_IMPORTED_MODULE_4___default.a.post("https://api.cloudinary.com/v1_1/dbx0fy8zz/image/upload", data);
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Header"], {
    ...
    __self: this
  }), "Create New Record"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Form"], {
    loading: loading,
    error: Boolean(error),
    success: success,
